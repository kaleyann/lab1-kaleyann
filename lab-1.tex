...
\begin{document}
\maketitle
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[interior hidden, borderline west={3pt}{0pt}{shadecolor}, boxrule=0pt, breakable, sharp corners, frame hidden, enhanced]}{\end{tcolorbox}}\fi
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{ggplot}\NormalTok{(midwest, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{percollege, }\AttributeTok{y=}\NormalTok{popdensity, }\AttributeTok{color=}\NormalTok{percbelowpoverty)) }\SpecialCharTok{+}
  ...
  \FunctionTok{labs}\NormalTok{( }\AttributeTok{x=}\StringTok{"\% college educated"}\NormalTok{,}
    \AttributeTok{y=}\StringTok{"population density (person/unit area)"}\NormalTok{,}
    \AttributeTok{title=} \StringTok{"Do people with college degrees tend to live in denser areas?"}\NormalTok{,}
    \AttributeTok{color=}\StringTok{"\% below }\SpecialCharTok{\textbackslash{}n}\StringTok{ poverty line"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{facet\_wrap}\NormalTok{(}\StringTok{"state"}\NormalTok{) }\SpecialCharTok{+}
...
{\centering \includegraphics{lab-1_files/figure-pdf/recreating-plot-1.pdf}
